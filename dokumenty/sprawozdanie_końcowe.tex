...
W badaniach wykorzystano bazę \textit{Fantasia Database} udostępnioną przez platformę PhysioNet. Zbiór zawiera 40 długoterminowych zapisów sygnału EKG zarejestrowanych u zdrowych ochotników podzielonych na dwie grupy wiekowe:
...
Ze względu na ograniczoną liczbę dostępnych pacjentów oraz zgodnie z zaleceniami dotyczącymi krótkoterminowej analizy HRV, każde 120-minutowe nagranie podzielono na niezależne segmenty o długości 5 minut (300 s).
...
Na podstawie wyznaczonego PSD obliczono moc sygnału w standardowych pasmach wykorzystywanych w analizie HRV:
...
\caption{Porównanie widm HRV dla reprezentatywnych przedstawicieli grup Young i Elderly.}
\label{fig:widma}
\end{figure}
...
Uzyskane wyniki potwierdzają istnienie zależności pomiędzy parametrami częstotliwościowymi HRV a wiekiem badanych osób. Analiza widmowa wykazała wyraźny spadek mocy w paśmie HF u osób starszych, co jest zgodne z obserwowanym w literaturze osłabieniem aktywności układu przywspółczulnego wraz z wiekiem.
